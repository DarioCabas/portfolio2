...
interface StyledMenuProps extends DetailedHTMLProps<{}, HTMLDivElement> {} // Define the proper type for your StyledMenu component

interface StyledHamburgerButtonProps extends DetailedHTMLProps<ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {
  menuOpen?: boolean;
} // Add menuOpen prop to StyledHamburgerButtonProps

interface StyledSidebarProps extends DetailedHTMLProps<{}, HTMLDivElement> {
  menuOpen?: boolean;
}
